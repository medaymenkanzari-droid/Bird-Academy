...
- Name: website-functional.spec.ts >> Vérification Fonctionnelle & Responsive >> TC-WEB-005: Page Tarifs avec éditions FREE, PREMIUM et PRO
- Location: tests\e2e\website-functional.spec.ts:15:7
...
Locator: getByText('FREE')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('FREE')
  - Test timeout of 30000ms exceeded.
