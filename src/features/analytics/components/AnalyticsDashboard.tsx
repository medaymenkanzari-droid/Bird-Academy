...
export const AnalyticsDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 md:px-0 min-w-0 w-full max-w-full">
      ...
      <div className="p-4 sm:p-5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xs space-y-4 min-w-0 max-w-full">
        <div className="flex flex-wrap items-center justify-between gap-2 pb-2 border-b border-slate-50 dark:border-slate-800/80 min-w-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 min-w-0 max-w-full">
          
          {/* Species */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterSpecies')}</label>
            <select
              value={filters.species || ''}
              onChange={(e) => setFilters(prev => ({ ...prev, species: e.target.value }))}
              className="w-full max-w-full min-w-0 px-2.5 py-1.5 rounded-lg border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-xs font-semibold focus:outline-none truncate"
            >
          ...
          {/* Breed */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterBreed')}</label>
            <select
              value={filters.breed || ''}
          ...
          {/* Mutation */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterMutation')}</label>
            <select
          ...
          {/* Zone */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterZone')}</label>
            <select
              value={filters.zone || ''}
          ...
          {/* Cage */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterCage')}</label>
            <select
              value={filters.cage || ''}
          ...
          {/* Origin */}
          <div className="space-y-1 min-w-0">
            <label className="text-[10px] font-black uppercase tracking-wider text-slate-450 block truncate">{at('filterOrigin')}</label>
            <select
      ...
      <HorizontalScrollContainer innerClassName="overflow-x-auto touch-pan-x min-w-0 border-b border-slate-100 dark:border-slate-800 gap-1 pb-1">
        {[
          ...
          <button
            ...
            className={`px-4 py-2.5 text-xs font-black rounded-xl transition-all flex items-center gap-1.5 shrink-0 cursor-pointer whitespace-nowrap ${
              activeTab === tab.id
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <MetricCard 
                ...
                value={formatCurrency(kpis.net_cashflow?.value || 0, settings.currency, true, language)} 
                icon={TrendingUp} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-xs text-slate-900 dark:text-slate-100 focus:outline-none"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-xs text-slate-900 dark:text-slate-100 focus:outline-none font-mono"
                  />
                </div>
