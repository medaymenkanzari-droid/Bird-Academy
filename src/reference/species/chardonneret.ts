...
export const CHARDONNERET_PROFILE: BiologicalSpeciesProfile = {
  ...
  traceability: {
    source: 'Convention de Berne / CITES Annexe II & Règlementation Européenne',
    revisionDate: '2026-08-03',
    validationStatus: 'verified',
    author: 'Comité Scientifique Bird Academy',
    disclaimer: {
      fr: 'Fiche scientifique validée. Espèce soumise à règlementation. Consultez un vétérinaire aviaire pour toute prescription médicale.',
      en: 'Validated scientific sheet. Species subject to regulations. Consult an avian veterinarian for any medical prescription.',
      ar: 'بطاقة علمية معتمدة. فصيل خاضع للوائح القانونية. استشر طبيباً بيطرياً لأي وصفة علاجية.',
      es: 'Ficha científica validada. Especie sujeta a regulaciones. Consulte a un veterinario aviar para cualquier prescripción médica.',
      it: 'Scheda scientifica validata. Specie soggetta a normativa. Consultare un veterinario per qualsiasi prescrizione.'
    }
  }
};
