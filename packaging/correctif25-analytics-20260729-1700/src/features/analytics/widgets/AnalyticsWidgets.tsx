  ...
  return (
    <div className="p-5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xs">
      ...
      <div className="mt-1.5 flex items-baseline gap-1">
        <span className="text-3xl font-black tracking-tight text-slate-850 dark:text-white font-mono">{value}</span>
      ...
      <div className="flex justify-between items-start">
        <div className="space-y-0.5">
          ...
          <div className="flex items-baseline gap-0.5">
            <span className="text-xl font-black tracking-tight text-slate-850 dark:text-white font-mono">{value}</span>
    ...
    <div className="p-4 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xs space-y-3">
      ...
      <div className="flex justify-between items-baseline">
        ...
        <span className="text-[10px] text-slate-400 font-medium">
          Précédent : <span className="font-bold font-mono">{pastValue}{unit}</span>
        </span>
      </div>
