...
export const PrivateBetaEcosystemTab: React.FC = () => {
  ...
  const [bugs, setBugs] = useState<BugTicket[]>([
    { id: 'BUG-101', title: 'Calculateur Wright - Délai de rafraîchissement au changement de couple', severity: 'major', module: 'Wright Engine', status: 'In Progress', date: '2026-07-15', reporter: 'Jean-Luc M.' },
    { id: 'BUG-102', title: 'Affichage des bagues en doublon lors de l\'import csv rapide', severity: 'critical', module: 'Database/CSV', status: 'Resolved', date: '2026-07-14', reporter: 'Sophie D.' },
    { id: 'BUG-103', title: 'Formulaire de couple : alignement du champ Date de ponte', severity: 'minor', module: 'UX/UI', status: 'Resolved', date: '2026-07-12', reporter: 'Pierre A.' },
    { id: 'BUG-104', title: 'Ajouter une exportation directe sous forme d\'image pour le graphe de pedigree', severity: 'suggestion', module: 'Pedigree Chart', status: 'Open', date: '2026-07-11', reporter: 'Hassan K.' },
  ]);
